...
# client = ChatOpenAI(api_key="YOUR_API_KEY", base_url="http://YOUR_SERVER_IP:11000/v1/", model="Qwen2-72B-Instruct")

client = OpenAI(base_url='http://YOUR_SERVER_IP:11000/v1/', api_key='YOUR_API_KEY')
tools = [
    {
        "schemas": "function",
        "function": {
